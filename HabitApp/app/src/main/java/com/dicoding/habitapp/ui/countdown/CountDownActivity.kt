...
class CountDownActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.eventCountDownFinish.observe(this@CountDownActivity) {updateButtonState(!it)}
        ...
        findViewById<Button>(R.id.btn_start).setOnClickListener {
            ...
            val build = Data.Builder().apply {
                putInt(HABIT_ID, habit.id)
                putString(HABIT_TITLE, habit.title)}.build()

            val mOneTimeWorkRequest = OneTimeWorkRequest.Builder(NotificationWorker::class.java)
                .setInputData(build)
